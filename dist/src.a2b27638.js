...
var createIncompleteList = function createIncompleteList(text) {
  ...
  div.className = "list-row"; // li作成

  var li = document.createElement("li");
  li.innerText = text; // button(完了)作成

  var completeButton = document.createElement("button");
  completeButton.innerText = "完了";
  completeButton.addEventListener("click", function () {
    //押された完了ボタンの親タグ(div)を削除
    deleteFromIncompleteList(completeButton.parentNode); // div生成

    var div = document.createElement("div");
    div.className = "list-row"; // li生成

    var li = document.createElement("li");
    li.innerText = completeButton.parentNode.firstElementChild.innerText; //戻るbutton生成
